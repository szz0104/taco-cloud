...
public class DesignAndOrderTacosBrowserTest {
    ...
    private void assertDesignPageElements() {
        ...
        List<WebElement> wraps = wrapGroup.findElements(By.tagName(HTML.Tag.DIV.toString()));
        ...
        List<WebElement> proteins = proteinGroup.findElements(By.tagName(HTML.Tag.DIV.toString()));
        ...
        List<WebElement> cheeses = proteinGroup.findElements(By.tagName(HTML.Tag.DIV.toString()));
        ...
        List<WebElement> veggies = proteinGroup.findElements(By.tagName(HTML.Tag.DIV.toString()));
        ...
        List<WebElement> sauces = proteinGroup.findElements(By.tagName(HTML.Tag.DIV.toString()));
    ...
    private void assertIngredient(WebElement ingredientGroup,
        ...
        List<WebElement> proteins = ingredientGroup.findElements(By.tagName(HTML.Tag.DIV.toString()));
        WebElement ingredient = proteins.get(ingredientIdx);
        assertEquals(id,
                ingredient.findElement(By.tagName(HTML.Tag.INPUT.toString())).getAttribute(HTML.Attribute.VALUE.toString()));
        assertEquals(name,
                ingredient.findElement(By.tagName(HTML.Tag.SPAN.toString())).getText());
    }
